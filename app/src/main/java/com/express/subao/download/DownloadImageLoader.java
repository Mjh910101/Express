...
public class DownloadImageLoader {
    ...
    private final static int INDEX_IMAGE = R.mipmap.logo_icon;
    private final static int FAIL_IMAGE = R.mipmap.logo_icon;
    private final static int EMPTY_IMAGE = R.mipmap.logo_icon;
